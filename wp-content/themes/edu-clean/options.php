<?php
global $options, $options4, $options5, $options6, $options7, $options8, $options9, $bp_existed, $bp_front_is_activity, $multi_site_on, $upload_path, $upload_url;
...
$ttpl_path = content_url() . $upload_url_trim  . '/' . $uploads_folder;;
$upload_url = content_url() . $upload_url_trim  . '/' . $uploads_folder;
