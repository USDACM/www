...
?>
<div style="margin: 0px 5px 5px 0px; float: left;" class="item-avatar"><a title="<?php echo $group->name . ' - ' . short_text($group_description, 150); ?>" href="<?php echo home_url() . '/' . BP_GROUPS_SLUG . '/' . $group->slug; ?>">
