...
<h4><?php _e('Welcome back', TEMPLATE_DOMAIN); ?><br /><a href="<?php bp_loggedin_user_link(); ?>"><?php global $bp; echo $bp->loggedin_user->fullname; ?></a></h4>
...
<input type="text" name="log" id="sidebar-user-login" class="inbox" value="<?php if(isset($user_login))echo esc_attr(stripslashes($user_login)); ?>" /></label>
