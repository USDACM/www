...
<div id="post-navigator">
<div class="alignright"><?php next_post_link(__('Older Entries &laquo; ', TEMPLATEPATH)); ?></div>
<div class="alignleft"><?php previous_post_link(__(' &raquo; Newer Entries', TEMPLATEPATH)); ?></div>
</div>
