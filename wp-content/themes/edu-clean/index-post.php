...
<?php _e('by', TEMPLATE_DOMAIN); ?> <?php if( isset($bp_existed) && $bp_existed == 'true' ) { ?> <?php printf( __( '%s',TEMPLATE_DOMAIN), bp_core_get_userlink( $post->post_author ) ) ?><?php } else { ?> <?php the_author_posts_link(); ?><?php } ?>&nbsp;<?php _e('in', TEMPLATE_DOMAIN); ?>&nbsp;<?php the_time('F jS Y') ?></div>
