...
if ((!isset($_POST['wpmudev-chat-settings-abspath'])) || (empty($_POST['wpmudev-chat-settings-abspath'])))
	die();
...
if ( $_POST['function'] !== "chat_messages_update" ) {
	...
	// Load in WP core.
	require( base64_decode($_POST['wpmudev-chat-settings-abspath']) .'wp-load.php' );
